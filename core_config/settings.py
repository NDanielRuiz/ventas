...
SECRET_KEY = 'django-insecure-c^#xir23wg^8ci&i&t^_@i%8f!j_s6os9vqck4mfqnzif&ae)x'
...
INSTALLED_APPS = [
    ...
    # Mis Aplicaciones (aquí la agregamos)
    'ventas',
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'gestordb',       # El nombre que le darás a tu base de datos
        'USER': 'postgres',               # Tu usuario de PostgreSQL (por defecto es 'postgres')
        'PASSWORD': 'dbpass123',      # La contraseña que pusiste al instalar PostgreSQL
...
LOGIN_URL = 'login'
LOGIN_REDIRECT_URL = 'dashboard' # <-- CAMBIA 'lista_clientes' POR 'dashboard'
